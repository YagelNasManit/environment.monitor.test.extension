package org.yagel.environment.monitor.test.plugin;

import org.apache.log4j.Logger;
import org.yagel.environment.monitor.test.plugin.status.provider.AbstractResourceStatusProvider;
import org.yagel.environment.monitor.test.plugin.status.provider.CoreApiServiceStatusProvider;
import org.yagel.environment.monitor.test.plugin.status.provider.DataBaseStatusProvider;
import org.yagel.environment.monitor.test.plugin.status.provider.WebUIStatusProvider;
...
public class TestStatusCollector implements MonitorStatusCollector {
  ...
  public Map<Resource, ResourceStatus> updateStatus() {
    ...
    Map<Resource, ResourceStatus> statusMap = new HashMap<Resource, ResourceStatus>();
